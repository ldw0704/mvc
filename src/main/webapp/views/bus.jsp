        ...
        <div class="pd16 pdb">
            ...
            <div class="select" id="backStart">
               <img src="views/img/img04.png">도착지
                <span class="fR">${vo.schoolname }</span><!--등교 도착지는 학교로 고정-->
            </div>
			<!--등교 -->
            ...
            <button class="mX mt40" onclick="location.href='Qrcode?uid=${vo.uid }'">QR Code 실행</button>
        </div>
        
    <div class="FAB">
        <ul class="ulFl">
            <li><a href="MyPage"><img src="views/img/ico01.png"><p>내정보</p></a></li>
            <li class="on"><a href=""><img src="views/img/ico02_on.png"><p>버스탑승</p></a></li>
